...
export const transtornoMentalSchema: FormSchema = {
  slug: "transtorno-mental",
  table: "transtorno_mental_reports",
  codigo: "F99",
  titulo: "Transtorno Mental Relacionado ao Trabalho",
  definicaoCaso:
    "Todo caso de sofrimento emocional em suas diversas formas de manifestação (choro fácil, tristeza, medo excessivo, doenças psicossomáticas, agitação, irritação, nervosismo, ansiedade, taquicardia, sudorese, insegurança, entre outros) que podem indicar o desenvolvimento ou agravo de transtornos mentais (CID-10 F00 a F99, Y90/Y91, Z73.0, R40 a R46, Z55 a Z65, Y96, X60 a X84), com elementos causais relacionados ao trabalho.",
  ...
  sections: [
    ...
    },
    {
      ...
      fields: [
        ...
        { key: "habitos", label: "Hábitos", type: "checkbox-group", options: ["Álcool", "Drogas psicoativas", "Psicofármacos"], fullWidth: true },
    ...
    },
    {
      ...
      fields: [
        ...
        { key: "outros_trabalhadores_mesma_doenca", label: "Há ou houve outros trabalhadores com a mesma doença no local de trabalho?", type: "select", options: OPCOES_SIM_NAO_COD },
        { key: "encaminhado_caps", label: "O paciente foi encaminhado a um CAPS ou outro serviço especializado em transtornos mentais?", type: "select", options: OPCOES_SIM_NAO_COD },
